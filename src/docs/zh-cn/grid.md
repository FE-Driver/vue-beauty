...
<style>
    .box-demo-show .grid-demo .demo-row {
...
<template>
    <div class="grid-demo">
        Gutter: <v-select size="lg" style="width: 200px;" :options="gutterOptions" v-model="gutter" @change="gutterChange"></v-select>{{ gutter }}
