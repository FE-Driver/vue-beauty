        ...
        <div role="tablist" class="ant-tabs-bar" tabindex="0">
            <div :class="containerCls">
                ...
                <div class="ant-tabs-nav-wrap">
                    <div class="ant-tabs-nav-scroll" ref="navScroll">
                        <div class="ant-tabs-nav" ref="nav""  :style="{ transform: 'translate3d(-' + tab_transform + 'px, 0px, 0px)' }">
                            <div class="ant-tabs-ink-bar ant-tabs-ink-bar-transition-forward" :style="barSty"></div>
                            <div role="tab" aria-disabled="false" aria-selected="false" :class="['ant-tabs-tab',{'ant-tabs-tab-active': index == activeIndex},{'ant-tabs-tab-disabled':tab.disabled}]" v-for="(tab, index) in tabs" @click="selectTab(index)">
